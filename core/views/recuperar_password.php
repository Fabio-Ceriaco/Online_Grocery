<section class="login-section">
    <div class="login-box">
        ...
        <br>
        <p>Por favor introduza o email associado a sua conta.</p>
        <?php if (isset($_SESSION['erro'])): ?>
            <span class="error mb-3" style="color: red; font-size: 0.8rem"><?php echo $_SESSION['erro'];
                                                                            unset($_SESSION['erro']); ?></span>
        <?php endif; ?>
        <form method="post" action="?q=recuperar_password_submit">
            <input type="email" id="email" name="email" placeholder="Email:" required><br>
            <input type="submit" id="submitlogin" value="Recuperar Password">
        </form>
